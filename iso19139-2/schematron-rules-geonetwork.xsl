...
<xsl:stylesheet xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 xmlns:gmi="http://sdi.eurac.edu/inspire/geonetwork/iso19139-2" version="2.0">
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//gmi:MI_Metadata|//*[@gco:isoType='gmd:MD_Metadata']" priority="1000"
                 mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//gmi:MI_Metadata|//*[@gco:isoType='gmd:MD_Metadata']"/>
