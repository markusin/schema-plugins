...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	version="1.0" xmlns:gmi="http://sdi.eurac.edu/inspire/geonetwork/iso19139-2">
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template match="//gmi:MI_Metadata|//*[@gco:isoType='gmd:MD_Metadata']" priority="1000" mode="M23">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gmi:MI_Metadata|//*[@gco:isoType='gmd:MD_Metadata']" />
