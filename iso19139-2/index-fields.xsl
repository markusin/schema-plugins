...
<xsl:stylesheet version="2.0"
	...
	xmlns:geonet="http://www.fao.org/geonetwork" xmlns:gmi="http://sdi.eurac.edu/inspire/geonetwork/iso19139-2"
	...
	<xsl:template match="/">
		...
		<Document locale="{$isoLangId}">
			...
			<!-- <xsl:apply-templates select="*[name(.)='gmi:MI_Metadata' or @gco:isoType='gmi:MI_Metadata']" 
				mode="metadata"/> -->
			<xsl:apply-templates select="gmi:MI_Metadata" mode="metadata" />
		</Document>
	</xsl:template>
